...
{
    public class GetMostRecommended : RibbonComponentControlBase
    {
        private readonly RequestRepository _requestRepository = new RequestRepository();

        public GetMostRecommended()
        {
            
        }

        public GetMostRecommended(RenderingParametersResolver parametersResolver)
        ...
        {
            this.Class = "sc-MostRecommended";
            this.Requires.Script("client", "MostRecommended.js");
